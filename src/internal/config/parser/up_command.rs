...
impl<'de> Deserialize<'de> for UpCommandConfig {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        struct Helper {
            ...
            auto_bootstrap: bool,
            #[serde(default = "default_notify_workdir_config_updated")]
            notify_workdir_config_updated: bool,
            #[serde(default = "default_notify_workdir_config_available")]
            notify_workdir_config_available: bool,
            #[serde(default = "default_attach_kill_timeout")]
            attach_kill_timeout: u64,
            #[serde(default = "default_attach_lock_timeout")]
            attach_lock_timeout: u64,
            #[serde(default)]
            preferred_tools: Vec<String>,
            #[serde(default = "default_mise_version")]
            mise_version: String,
            ...
            upgrade: bool,
            #[serde(default)]
            operations: UpCommandOperationConfig,
        }

        fn default_auto_bootstrap() -> bool {
            true
        }
        fn default_notify_workdir_config_updated() -> bool {
            true
        }
        fn default_notify_workdir_config_available() -> bool {
            true
        }
        fn default_attach_kill_timeout() -> u64 {
            600
        }
        fn default_attach_lock_timeout() -> u64 {
            5
        }
        fn default_mise_version() -> String {
            "latest".to_string()
        }
        ...
        Ok(UpCommandConfig {
            auto_bootstrap: helper.auto_bootstrap,
            notify_workdir_config_updated: helper.notify_workdir_config_updated,
            notify_workdir_config_available: helper.notify_workdir_config_available,
            attach_kill_timeout: helper.attach_kill_timeout,
            attach_lock_timeout: helper.attach_lock_timeout,
            preferred_tools: helper.preferred_tools,
            mise_version: helper.mise_version,
            uv_version: helper.uv_version,
...
// Manual Deserialize implementation for compatibility with existing code
impl<'de> Deserialize<'de> for UpCommandOperationConfig {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct Helper {
            ...
            sources: Vec<String>,
            #[serde(default)]
            mise: UpCommandOperationMiseConfig,
            #[serde(rename = "cargo-install", default)]
            cargo_install: UpCommandOperationCargoInstallConfig,
            #[serde(rename = "go-install", default)]
            go_install: UpCommandOperationGoInstallConfig,
            #[serde(rename = "github-release", default)]
            github_release: UpCommandOperationGithubReleaseConfig,
        }

        let helper = Helper::deserialize(deserializer)?;
        Ok(UpCommandOperationConfig {
...
// Manual Deserialize implementation for compatibility with existing code
impl<'de> Deserialize<'de> for UpCommandOperationMiseConfig {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct Helper {
            ...
            sources: Vec<String>,
            #[serde(default)]
            default_plugin_sources: HashMap<String, String>,
        }

        let helper = Helper::deserialize(deserializer)?;
        Ok(UpCommandOperationMiseConfig {
            backends: helper.backends,
            sources: helper.sources,
            default_plugin_sources: helper.default_plugin_sources,
        })
    }
}
...
// Manual Deserialize implementation for compatibility with existing code
impl<'de> Deserialize<'de> for UpCommandOperationCargoInstallConfig {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        let helper = Helper::deserialize(deserializer)?;
        Ok(UpCommandOperationCargoInstallConfig {
            crates: helper.crates,
        })
    }
}
...
// Manual Deserialize implementation for compatibility with existing code
impl<'de> Deserialize<'de> for UpCommandOperationGoInstallConfig {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        let helper = Helper::deserialize(deserializer)?;
        Ok(UpCommandOperationGoInstallConfig {
            sources: helper.sources,
        })
    }
}
...
// Manual Deserialize implementation for compatibility with existing code
impl<'de> Deserialize<'de> for UpCommandOperationGithubReleaseConfig {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        let helper = Helper::deserialize(deserializer)?;
        Ok(UpCommandOperationGithubReleaseConfig {
            repositories: helper.repositories,
        })
    }
}
